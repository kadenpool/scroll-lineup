...
SCRIPT_VERSION = "floor_kernel v5 (24 Sep 2026): v4 + G3 needs the planted letters to read at s = 1 (median AUC at least 0.70), checkpoints pinned by revision and sha256, clipping over the model's layers"
T0 = time.time()

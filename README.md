...
and rendering the 48 um-grid mesh, which
needs no transform, instead of the 187 um-grid
one carried by the official transform, reads
0.897 and finds 72 % of the labelled ink
